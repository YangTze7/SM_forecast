...
def create_parser():
    ...
    parser.add_argument('--ex_name', '-ex', default='gldas_tau_sub', type=str)
    ...
    parser.add_argument('--data_root', default='/home/gldas_demo/gldas_vars_clipped')
    # parser.add_argument('--event', default='0ll8.tif')
    parser.add_argument('--dataname', '-d', default='gldas', type=str,
    ...
    # method parameters
    parser.add_argument('--method', '-m', default='TAU', type=str,
    ...
    parser.add_argument('--config_file', '-c', default='configs/gldas/TAU.py', type=str,
